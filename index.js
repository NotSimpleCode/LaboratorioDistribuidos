...
//importar las funciones sql
import {agregarContacto,borrarContacto,obtenerConctactos} from './src/mysql_conector.js'
let todos
...
app.get('/',function(req,res){
    ...
    //conectar()- Conectar cuando ya estaba conectado
    todos = obtenerConctactos()
    //pasar datos al html
